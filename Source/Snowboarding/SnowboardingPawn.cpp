...
ASnowboardingPawn::ASnowboardingPawn()
{
	...
	Vehicle4W->WheelSetups[0].WheelClass = USnowboardingWheelFront::StaticClass();
	Vehicle4W->WheelSetups[0].BoneName = FName("Wheel_Front_Left");
	Vehicle4W->WheelSetups[0].AdditionalOffset = FVector(0.f, -12.f, 0.f);

	Vehicle4W->WheelSetups[1].WheelClass = USnowboardingWheelFront::StaticClass();
	Vehicle4W->WheelSetups[1].BoneName = FName("Wheel_Front_Right");
	Vehicle4W->WheelSetups[1].AdditionalOffset = FVector(0.f, 12.f, 0.f);

	Vehicle4W->WheelSetups[2].WheelClass = USnowboardingWheelRear::StaticClass();
	Vehicle4W->WheelSetups[2].BoneName = FName("Wheel_Rear_Left");
	Vehicle4W->WheelSetups[2].AdditionalOffset = FVector(0.f, -12.f, 0.f);

	Vehicle4W->WheelSetups[3].WheelClass = USnowboardingWheelRear::StaticClass();
...
void ASnowboardingPawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Handbrake", IE_Pressed, this, &ASnowboardingPawn::OnHandbrakePressed);
	PlayerInputComponent->BindAction("Handbrake", IE_Released, this, &ASnowboardingPawn::OnHandbrakeReleased);
	PlayerInputComponent->BindAction("SwitchCamera", IE_Pressed, this, &ASnowboardingPawn::OnToggleCamera);

	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ASnowboardingPawn::OnResetVR); 
}
...
void ASnowboardingPawn::OnHandbrakePressed()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(true);
}

void ASnowboardingPawn::OnHandbrakeReleased()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(false);
}

void ASnowboardingPawn::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void ASnowboardingPawn::EnableIncarView(const bool bState, const bool bForce)
{
...
void ASnowboardingPawn::OnResetVR()
{
#if HMD_MODULE_INCLUDED
...
void ASnowboardingPawn::UpdateHUDStrings()
{
...
void ASnowboardingPawn::SetupInCarHUD()
{
